...
class Server {
	...
	public function __construct(array $args = null) {
		//$isaac = new ISAAC(array(55345345, 55345345 >> 32, 767535324, 767535324 >> 32));
		//$this->log($isaac->getNextKey());
		/*$this->log(-10 >> 3);
		$this->log(-10 << 3);
		$this->log(-10 & 3);*/
		$this->log("POSITIVE: " . $this->urshift(10, 3));
		$this->log("NEGATIVE: " . $this->urshift(-10, 3));
		die();
...
class ISAAC {
	...
	public $count, $accumulator, $lastResult, $counter;
